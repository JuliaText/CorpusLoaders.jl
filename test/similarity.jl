...
@testset "SCWS" begin
	eg ="""1	Brazil	n	nut	n	income in <b> Brazil </b> the philosophy	neck the <b> nut </b> a thin tension	1.1	0.0	3.0	0.0	0.0	0.0	0.0	2.0	6.0	0.0	0.0
...
"""
	...
	@test sims == [1.1, 0.6]
	@test contexts[1,1] == ["income", "in", "the", "philosophy"]
